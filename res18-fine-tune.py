# -*- coding: utf-8 -*-
"""
Created on Wed Jan  2 15:28:10 2019

Residual network v2 architure
fine-tune
...
sess=tf.Session()
saver=tf.train.import_meta_graph('new-start/model.ckpt-2059.meta')
saver.restore(sess,tf.train.latest_checkpoint('new-start/'))
...
while(dl.epoch>0):
    ...
    if (dl.epoch>0):
        ...
        if (b>max_acc):
            max_acc=b
            saver.save(sess,'2019-1-7/model.ckpt',global_step=iteration)
        train_acc.append(a)
        test_acc.append(b)
